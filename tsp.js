...
function formatDirections(gdir, mode) {
    ...
    for (var i = 0; i < gdir.legs.length; ++i) {
        ...
        retStr += "\t<tr class='heading'><td class='heading' width=40>"
            + "<div class='centered-directions'><img src='http://www.gebweb.net/optimap/newicons/black"
            + number + ".png'></div></td>"
        ...
        dragStr += "<li id='" + i + "' class='ui-state-"
            + (i ? "default" : "disabled") + "'>"
            + "<table class='dragTable'><tr><td class='left'><img src='http://www.gebweb.net/optimap/newicons/black"
    ...
    if (mode == 0) {
        ...
        dragStr += "<li id='" + 0 + "' class='ui-state-disabled'>"
            + "<table class='dragTable'><tr><td><img src='http://www.gebweb.net/optimap/newicons/black"
            + 1 + ".png' /></td><td>" + headerStr
            + "</td></tr></table></li>";
        retStr += "\t<tr class='heading'><td class='heading'>"
            + "<div class='centered-directions'><img src='http://www.gebweb.net/optimap/newicons/black1.png'></div></td>"
            + "<td class='heading'>"
...
function drawMarker(latlng, addr, label, num) {
    var icon;
    icon = new google.maps.MarkerImage("http://www.gebweb.net/optimap/newicons/red" + (num + 1) + ".png");
...
function onSolveCallback(myTsp) {
    ...
    if (mode == 1) {
        ...
        var myIcn1 = new google.maps.MarkerImage("http://www.gebweb.net/optimap/newicons/black1.png");
        var marker = new google.maps.Marker({
            position: myPt1,
            icon: myIcn1,
            map: gebMap });
    ...
    for (var i = 0; i < dir.legs.length; ++i) {
        ...
        if (i == dir.legs.length - 1 && mode == 0) {
            myIcn1 = new google.maps.MarkerImage("http://www.gebweb.net/optimap/newicons/black1.png");
        } else {
            myIcn1 = new google.maps.MarkerImage("http://www.gebweb.net/optimap/newicons/black" + (i + 2) + ".png");
        }
        var marker = new google.maps.Marker({
            position: myPt1,
            icon: myIcn1,
